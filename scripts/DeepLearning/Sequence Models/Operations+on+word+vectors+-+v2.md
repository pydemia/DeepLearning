...
Revised Version:
![](https://d3c33hcgiwev3.cloudfront.net/imageAssetProxy.v1/PgPTTQqLEeiIOArs7r1YtA_0f59b59dcebcb6752f724d6425590c33_all.jpg?expiry=1518307200000&hmac=K2jCUdXsuaJCg2mCNjw_cuCfWz0AWZDEXDPAn6xyU-U)
...
def equalize(pair, bias_axis, word_to_vec_map):
    ...
    corrected_e_w2B = np.sqrt(np.abs(1 - (np.linalg.norm(mu_orth) ** 2))) * ((e_w2B - mu_B) / (np.linalg.norm(e_w1B - mu_B)))
